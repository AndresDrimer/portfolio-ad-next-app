    ...
    <div className="w-full">
      <div className="w-screen relative h-[20vh] lg:h-[30vh] ">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">{data.projects[id].title}</h2>
          <h3>{data.projects[id].tech}</h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <button className="px-8 py-2 mt-4 mr-8"><a href={data.projects[id].externalUrl} target="_blank">Demo</a></button>
          <button className="px-8 py-2 mt-4 "><a href={data.projects[id].gitHubUrl} target="_blank">Code</a></button>
        </div>
