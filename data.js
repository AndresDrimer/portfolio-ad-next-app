export default {
    ...
    sections: ["home", "stack", "works", "contact"],
    aboutPhoto: "/assets/portrait2.jpeg",
    status:
      "I´m available for your project! Contact me and we´ll talk",
    contact: 
      {
    ...
    resume:
      "https://drive.google.com/file/d/10x1LI4mItZyLHihfrILCnRwAdY1qha75/view?usp=sharing",
    about: {
    ...
    projects: [
      ...
      {
        id: 1,
        imageInside: "/assets/mockups/desktop/chaira-desktop.png",
        imageBck: "/assets/mockups/iphone/chaira-iphone.png",
        title: "Chaira Música",
        tech: "Laravel",
        techDetail: ["Laravel"],
        anchor: "chaira",
        externalUrl: "https://chairamusica.com.ar/",
        gitHubUrl: "",
        description:
          "Chaira is a sonic branding agency that offers state-of-the-art solutions in music and sound for artistic projects, including film and television productions, advertising, live performances, sound installations, interactive exhibitions, and digital content creation for web and social media platforms. I made this site using Laravel, it hosts videos from vimeo and youtube, it is optimized to run really quickly and efficiently in browsers and it also has an interesting blog in it. Great project!",
      },
      {
        id: 2,
    ...
    }, 
    {
      ...
      title: "Fuerza invisible",
      tech: "WORDPRESS CUSTOM THEME",
      techDetail: ["FIGMA",  "Wordpress"],
      anchor: "poetry",
      externalUrl: "https://fuerzainvisible.adrimer.com.ar/",
      gitHubUrl: "https://github.com/AndresDrimer/fuerzainvisible",
      description:
      "'Fuerza Invisible' is built upon my own Poetry template. It offers an exceptional platform for showcasing texts with a visually appealing and comfortable layout. This template provides a unique opportunity to present poetry in a manner that is both engaging and aesthetically pleasing, making it an ideal choice for those looking to enhance their literary presentations. Additionally, it's designed to effortlessly display a wide range of poetic forms, allowing for the seamless presentation of various types of poetry with ease.",
    },
    {
      id: 6,
